...
public static class AssetBundleLoader
{
    ...
    private static AssetBundle singleBundle = null;
    public static AssetBundle SingleBundle
    {
        get
        {
            var loadedBundle = singleBundle;
            singleBundle = null;
            return loadedBundle;
        }
    ...
    public static IEnumerator LoadSingleBundle(string name)
    {
        ...
        UnityWebRequest request = UnityWebRequestAssetBundle.GetAssetBundle(AssetBundleLoader.BundlePath + name);
