...
public class UM_NotificationsExample : MonoBehaviour
{
    ...
    [SerializeField] Button m_schegule = null;
    [SerializeField] Button m_removeDelivered = null;
    [SerializeField] Button m_removePending = null;
    ...
    private void Start() {
        ...
        UM_NotificationRequest startRequest = client.LastOpenedNotification;
